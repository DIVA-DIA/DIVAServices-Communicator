...
import request.DivaCollection;
import request.DivaImage;
...
public class DivaServicesCommunicator {
    ...
    public DivaServicesResponse<Object> runOcropyTextExtraction(DivaServicesRequest request) throws MethodNotAvailableException, IOException {
        Map<String, Object> highlighter = new HashMap();
     ...
     */
    public DivaServicesResponse<Point> runMultiScaleInterestPointDetection(DivaServicesRequest request, String detector, float blurSigma, int numScales, int numOctaves, float threshold, int maxFeaturesPerScale) throws MethodNotAvailableException, IOException {
     ...
     * @return
     */
    public DivaServicesResponse<Object> runOtsuBinarization(DivaServicesRequest request) throws MethodNotAvailableException, IOException {
     ...
     * @throws exceptions.MethodNotAvailableException
     * @throws java.io.IOException
     */
    public DivaServicesResponse<Rectangle> runHistogramTextLineExtraction(DivaServicesRequest request, Rectangle rectangle) throws MethodNotAvailableException, IOException {
        Map<String, Object> highlighter = new HashMap();
     ...
     * @return
     */
    public DivaServicesResponse<Object> runSauvolaBinarization(DivaServicesRequest request) throws MethodNotAvailableException, IOException {
        JSONObject jsonRequest = createImagesOnlyRequest(request);
    ...
    */
    ...
    public DivaServicesResponse<Object> runImageInverting(DivaServicesRequest request) throws MethodNotAvailableException, IOException {
        JSONObject jsonRequest = createImagesOnlyRequest(request);
     ...
     * @return
     */
    public DivaServicesResponse<Polygon> runSeamCarvingTextlineExtraction(DivaServicesRequest request, Rectangle rectangle, float smooth, float sigma, int slices) throws MethodNotAvailableException, IOException {
        Map<String, Object> highlighter = new HashMap();
        highlighter.put("segments", prepareRectangle(rectangle));
        highlighter.put("closed", true);
        highlighter.put("type", "rectangle");
     ...
     * @return result image
     */
    public DivaServicesResponse<Object> runCannyEdgeDetection(DivaServicesRequest request) throws MethodNotAvailableException, IOException {
        JSONObject jsonRequest = createImagesOnlyRequest(request);
     ...
     * @return output image
     */
    public DivaServicesResponse<Object> runHistogramEnhancement(DivaServicesRequest request) throws MethodNotAvailableException, IOException {
        JSONObject jsonRequest = createImagesOnlyRequest(request);
     ...
     * @return output image
     */
    public DivaServicesResponse<Object> runLaplacianSharpening(DivaServicesRequest request, int sharpLevel) throws MethodNotAvailableException, IOException {
        JSONObject jsonRequest = new JSONObject();
        JSONObject inputs = new JSONObject();
     ...
     */
    public DivaServicesResponse<Object> runOcropyBinarization(DivaServicesRequest request) throws MethodNotAvailableException, IOException {
        JSONObject jsonRequest = createImagesOnlyRequest(request);
    ...
    public DivaServicesResponse<Object> runKrakenBinarization(DivaServicesRequest request) throws MethodNotAvailableException, IOException {
        JSONObject jsonRequest = createImagesOnlyRequest(request);
        logJsonObject(jsonRequest);
        JSONObject postResult = HttpRequest.executePost(connection.getServerUrl() + "/binarization/krakenbinarization/1", jsonRequest);
    ...
    public DivaServicesResponse<Object> runDecolorization(DivaServicesRequest request, float effect, float noise) throws MethodNotAvailableException, IOException {
        JSONObject jsonRequest = new JSONObject();
        JSONObject inputs = new JSONObject();
     ...
     */
    public DivaServicesResponse<Object> runOcropyPageSegmentation(DivaServicesRequest request, boolean requireOutputImage) throws MethodNotAvailableException, IOException {
        JSONObject jsonRequest = createImagesOnlyRequest(request);
    ...
    public DivaCollection createCollection(List<BufferedImage> images) throws IOException {
        DivaCollection collection = DivaCollection.createCollectionWithImages(images, connection);
        return collection;
    }

    public DivaCollection createCollection(String name) throws CollectionException, IOException {
     ...
     */
    private boolean checkImageOnServer(BufferedImage image) throws IOException {
     ...
     * @return True if the image is already saved on the server, false otherwise
     */
    private boolean checkImageOnServer(String md5) throws MalformedURLException, IOException {
